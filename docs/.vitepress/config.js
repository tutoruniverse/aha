      ...
      { 
        ...
        items: [
          { 
            text: 'Page Sections',
            items: [
              { text: 'CTA Sections', link: '/examples/marketing/page-sections/cta-sections' },
              { text: 'Logo Clouds', link: '/examples/marketing/page-sections/logo-clouds' },
              { text: 'Team Sections', link: '/examples/marketing/page-sections/team-sections' },
            ],
          },
          { 
            text: 'Elements',
            items: [
              ...
              { text: 'Flyout Menus', link: '/examples/marketing/elements/flyout-menus' },
          ...
          { 
            text: 'Page Templates',
            items: [
              { text: '404 Pages', link: '/examples/marketing/page-examples/404-pages' },
              { text: 'Contact Pages', link: '/examples/marketing/page-examples/contact-pages' },
              { text: 'Pricing Pages', link: '/examples/marketing/page-examples/pricing-pages' },
              { text: 'Landing Pages', link: '/examples/marketing/page-examples/landing-pages' },
            ],
          },
        ],
      },
      { 
        ...
        items: [
          { 
            text: 'Forms',
            items: [
              { text: 'Form Layouts', link: '/examples/application-ui/forms/form-layouts' },
              { text: 'Input Groups', link: '/examples/application-ui/forms/input-groups' },
              { text: 'Select Menus', link: '/examples/application-ui/forms/select-menus' },
              { text: 'Sign-in and Registration', link: '/examples/application-ui/forms/sign-in-and-registration' },
            ],
          },
        ],
      },
